...
export default function Footer() {
  return (
    <footer>
      ...
      <img className='w-48' src="https://i.ibb.co/0sHCMWj/woodhy-high-resolution-logo-transparent.png" alt="woodhy-high-resolution-logo-transparent" border="0"/>
      <p className='mt-5 text-lg text-gray-600'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Consequuntur magnam debitis iure laboriosam vero</p>
      </div>
    ...
    <div className='flex items-start ml-10 md:pl-40 md:pr-40 text-gray-800 mt-5'>© 2023 by Woodhy Furniture. All rights reserved </div>
    </footer>
