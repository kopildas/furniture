...
export default function SignUp_popup({ onClosing_Signup_pop,login_from_signup_pop }) {
    ...
    >
      ...
      >
        <div className="w-full max-w-sm rounded-lg p-6 grid">
          ...
          <form onSubmit={handleSignup} className="bg-slate-00 p-5 rounded-md">
          ...
          <button id="close" onClick={handleOnChange}>Close</button>
        </div>
      </div>)}
    </div>
  );
