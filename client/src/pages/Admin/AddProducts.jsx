...
export default function AddProducts() {
 ...
 setFormData((prevState) => ({
  ...
  async function onSubmit(e) {
    ...
    try {
      const response = await axios.post(`${link}/api/v1/products`, formData);
      console.log(response);
  ...
  return (
    <div className="mt-20 text-black flex bg-slate-50">
      ...
      <div className="w-full p-10">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="px-3 py-0 text-lg text-white duration-150 ease-in-out bg-blue-500 rounded hover:bg-blue-700 w-32 h-10"
          >
            View All
          </button>
        </div>
